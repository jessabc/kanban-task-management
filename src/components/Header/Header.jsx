    ...
    return (
        <div className='flex'>
            ...
            <div className='flex w-full px-10 py-10 items-center dark:bg-zinc-800 sm:pl-0'>
                ...
                {/* mobile logo */}
                <img src={logoMobile} alt='mobile logo icon' className='mr-3 sm:hidden'/>
                ...
                <div 
                    ...
                    {/* chevron */}
                    <div 
                    className={`${isMenuModalVisible ? 'ml-1 mt-auto mb-auto' : 'mt-auto ml-1'} sm:hidden`}>
                        <div>
                            <img src={iconChevronDown} alt='down chevron icon' className={`${isMenuModalVisible ? 'hidden' : 'block'} `}/> 
                        </div>
                        <div>
                            <img src={iconChevronUp} alt='up chevron icon' className={`${isMenuModalVisible ? 'block' : 'hidden'}`}/> 
                        </div>  
                    </div>
                </div>               
                ...
                <div className='ml-auto mt-auto mr-3'>
                    ...
                    <button 
                        ...
                        {size.width < 640 ? <img src={iconAddTaskMobile} alt='plus icon to add task' className='w-4 h-4'/> : '+ Add New Task'}
                    </button>
                ...
                <div className='flex flex-col'>
                    ...
                    <button 
                        ...
                        <img src={iconVerticalEllipsis} alt='vertical ellipsis icon'  className='cursor-pointer'/>
                    </button>
