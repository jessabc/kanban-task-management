...
//    sticky header credit to https://dev.to/cryptic022/sticky-header-and-footer-with-tailwind-2oik
    return (
            ...
            {/* logo */}
              ...
              {size.width > 640 && 
               <div className='flex items-center w-2/5   h-full pl-5 dark:bg-zinc-800'>
                 {theme === 'dark' ?<img src={logoDark} alt="" className=''/> : <img src={logoLight} alt="" className=''/>}
     ...
     {size.width < 640 &&  
                ...
                <button onClick={setIsEditDeletBoardModalVisible} className='mt-auto hover:bg-indigo-100 dark:hover:bg-gray-700 hover:p-2   hover:pb-1 hover:rounded-full p-2 pb-1 cursor-pointer'>
