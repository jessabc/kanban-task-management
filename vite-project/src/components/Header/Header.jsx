    ...
    return (
        <div className='flex  '>
            ...
            {/* logo */}
               ...
               {size.width > 640 && 
               <div className='flex items-center   h-full pl-5 pr-32 '>
                    <img src={logoDark} alt="" className=''/>
                </div>
              }
          
            
            <div className='flex w-full px-10 py-10 items-center '>
     {size.width < 640 &&  
                ...
                :<p className='font-semibold text-2xl -mb-1' >{currentBoardName}</p>}
                ...
                <div className='ml-auto mt-auto mr-3  '>
                    ...
                    <button onClick={() => setIsNewTaskModalVisible(true)} className={` ${size.width < 640 ? "bg-indigo-500 py-1 px-2 rounded-full": "w-content py-1 px-2 text-md bg-indigo-500  font-bold text-indigo-50 rounded-full   cursor-pointer pb-1 hover:bg-indigo-400"}`}> 
